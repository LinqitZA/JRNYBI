...
This command **requires** the project directory as an argument via `/home/linqadmin/repo/jrnybi`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/home/linqadmin/repo/jrnybi/.autoforge/prompts/app_spec.txt` and `/home/linqadmin/repo/jrnybi/.autoforge/prompts/initializer_prompt.md`

If `/home/linqadmin/repo/jrnybi` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/home/linqadmin/repo/jrnybi/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/home/linqadmin/repo/jrnybi/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/home/linqadmin/repo/jrnybi/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/home/linqadmin/repo/jrnybi/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/home/linqadmin/repo/jrnybi/.autoforge/prompts/`!
>
> **Files created:**
> - `/home/linqadmin/repo/jrnybi/.autoforge/prompts/app_spec.txt`
> - `/home/linqadmin/repo/jrnybi/.autoforge/prompts/initializer_prompt.md`
>
